...
\setlength{\parskip}{0.35em}  % Absatzeinrückung
...
% Erstnennung: nur Kurzform im Text, Eintrag im Verzeichnis bleibt
% verlinkt (blau). Verwendung: \acfirst{API} bei der ersten Nennung,
% danach \acs{API}.
\newcommand{\acfirst}[1]{\phantomsection\label{acro:#1}\acused{#1}\acs{#1}}
\usepackage{hyperref}
\hypersetup{
    colorlinks=true,
    linkcolor=blue,
