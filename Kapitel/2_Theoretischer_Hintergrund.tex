...
Unternehmen und Konsumenten, \acs{B2C}, sowie zwischen Unternehmen
untereinander, \acs{B2B} \cite{turban_ecommerce}. Der Begriff schließt
...
eine Bibliothek vorgefertigter, \acs{PCI-DSS}-konformer UI-Komponenten
...
Daten, die über eine \acs{API} vom Backend abgerufen werden. Diese
...
Ansichten der Anwendung anhand der \acs{URL} darzustellen. React
...
rollenbasierten Zugriffskontrolle (\acs{RBAC}), das den Zugriff
...
der Web Content Accessibility Guidelines (\acs{WCAG}~2.1), ist
...
\textit{Bazario} über REST-basierte \acs{HTTP}-Schnittstellen.
