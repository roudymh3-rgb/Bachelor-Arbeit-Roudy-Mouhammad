...
bereits auf Stripe aufbaut. Die Zahlungsabwicklung selbst
erfolgt dabei serverseitig; das Frontend leitet den Nutzer
lediglich auf eine vom Backend bereitgestellte,
\acs{PCI-DSS}-konforme Stripe-Zahlungsseite weiter und
verarbeitet nach Abschluss der Zahlung die Weiterleitung
auf die Erfolgs- beziehungsweise Abbruchseite. Eine
Einbindung von Stripe Elements oder React Stripe.js im
Frontend ist damit für den aktuellen Funktionsumfang nicht
erforderlich; sie käme erst bei einer Erweiterung um eine
eigene, im Frontend gestaltete Zahlungsoberfläche in Betracht
...
kein Paket-Lock-in \\
\hline
Stripe (Redirect) & Zahlungsabwicklung &
Weiterleitung auf vom Backend bereitgestellte,
\acs{PCI-DSS}-konforme Zahlungsseite \\
\hline
