...
bevor der Vorgang fortgesetzt wird. Diese Einschränkung ist
begründet: Die Plattform muss den Vorgang einem Nutzer zuordnen
können, um ihn nachverfolgbar zu machen, dem Anbieter mitzuteilen, wer
bestellt hat, und dem Kunden die Einsicht in seine Bestellungen zu
ermöglichen. Bei Verkaufsplattformen, die einen Kauf ohne Anmeldung
zulassen, wird die Zahlung über die Plattform selbst abgewickelt, die
dabei zwangsläufig die Daten des Kunden erhält. In \textit{Bazario}
werden Zahlungsdaten dagegen ausschließlich an den Zahlungsdienst
übermittelt (vgl. Abschnitt~\ref{subsec:online-zahlung}); ohne
Anmeldung läge der Plattform daher keinerlei Information über den
Vorgang vor.
...
Für die Zahlungsabwicklung selbst bestehen grundsätzlich zwei Wege.
Entweder wickelt die Plattform die Zahlung eigenständig ab und
benötigt dafür eine Anbindung an Banken und Zahlungsdienstleister,
wobei sämtliche Zahlungsdaten über die eigene Infrastruktur laufen und
den entsprechenden regulatorischen Anforderungen unterliegen. Oder sie
nutzt einen externen Anbieter, der diese Anbindung bereits
bereitstellt. \textit{Bazario} verwendet den zweiten Weg über die von
Stripe gehostete Zahlungsseite (vgl.
Abschnitt~\ref{subsec:online-zahlung}). Das Frontend gestaltet damit
...
Der Zugang zum Dashboard erfolgt über die Kontoübersicht (vgl.
Abschnitt~\ref{subsec:auth-onboarding}), die zusätzlich zu den
dort beschriebenen Auth-bezogenen Inhalten zusammenfassende
Kennzahlen zu Bestellungen und Buchungen sowie Verweise auf die
Dienstleistungs- und Verfügbarkeitsverwaltung bereitstellt.
