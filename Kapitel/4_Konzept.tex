...
Die Werte sind hexadezimal notiert. Eine Ausnahme bildet
\texttt{destructive}, das in \acs{OKLCH} angegeben ist; in diesem
Farbraum entspricht die Helligkeitskomponente näherungsweise der
wahrgenommenen Helligkeit, wodurch sich die hellere Fassung für die
dunkle Darstellung unmittelbar ableiten lässt \cite{css_color_4}.
...
Weiß. In der dunklen Darstellung kehrt sich das Verhältnis um, die
Karte ist dort geringfügig heller als die Seite. Der Rahmen ist
deshalb bewusst schwach gesetzt; er verstärkt eine Trennung, die
bereits über die Fläche entsteht, statt sie allein zu tragen.
...
Da die Komponenten überwiegend die funktionalen Token referenzieren,
erfordert der Wechsel keine Änderung an den Komponenten selbst. Zwei
Ausnahmen bestehen: Die Zustandsmarkierungen für Bestellungen,
Buchungen und Werbeanzeigen greifen auf feste Farbwerte zurück, da
sie eine Bedeutung tragen, die von der Darstellungsvariante
unabhängig ist -- eine bezahlte Bestellung ist in beiden Fassungen
grün. Die Kopfzeile enthält ebenfalls feste Werte; sie folgt dem
Token-System bislang nicht.
 
% ---------------------------------------------------------------
% TODO (Roudy): Falls du die Kopfzeile noch auf Tokens umstellst
% (13 feste Hexwerte in components/shared/app-header.tsx), entfaellt
% der letzte Satz und der Absatz endet nach "gruen".
% ---------------------------------------------------------------
