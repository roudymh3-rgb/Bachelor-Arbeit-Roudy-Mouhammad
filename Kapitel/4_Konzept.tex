...
% ---------------------------------------------------------------
% TODO (Roudy): Der folgende Absatz beschreibt, WAS im Code steht.
% WARUM du dich fuer dieses Schema entschieden hast, fehlt und muss
% von dir kommen -- etwa aus dem Gespraech mit dem Mentor.
% ---------------------------------------------------------------
...
Die Werte sind hexadezimal notiert; allein \texttt{destructive} ist
in \acs{OKLCH} angegeben, einem Farbraum, dessen
Helligkeitskomponente näherungsweise der wahrgenommenen Helligkeit
entspricht \cite{css_color_4}. Abstufungen desselben Farbtons lassen
sich darin gleichmäßig ableiten, was für einen Warnwert nützlich ist,
der in mehreren Sättigungen erscheinen kann.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{Bilder/abb_rahmen.pdf}
\caption{Aufbau des Anwendungsrahmens in beiden Anmeldezuständen;
gestrichelt hervorgehoben ist der einzige Bereich, der sich zwischen
ihnen unterscheidet (Strukturskizze, eigene Darstellung)}
\label{fig:rahmen}
\end{figure}
...
getönt dargestellt sind die vier Bereiche für Ankündigungen und
Werbung, der angeschnittene Block am rechten Rand deutet den nächsten
Eintrag der Schleife an (Strukturskizze, eigene Darstellung)}
\label{fig:startseite}
\end{figure}
 
Die Startseite gliedert sich in bis zu sechs aufeinanderfolgende
Abschnitte. Einen eigenen Seitentitel trägt sie nicht: Sie ist der
Einstiegspunkt der Anwendung, und die Überschrift jedes Abschnitts
benennt bereits, was in ihm zu finden ist.
 
Den Anfang bilden die Ankündigungen des Marktplatzes, darauf folgen
die drei Werbebereiche in absteigender Sponsorenstufe und erst danach
der Katalog. Reihenfolge und Größe der Platzierungen ergeben sich
dabei aus dem Werbemodell und sind in
Abschnitt~\ref{subsec:werbung_konzept} beschrieben. Für die
Seitenstruktur ist zweierlei maßgeblich: Ein Bereich ohne Einträge
wird nicht dargestellt, sodass die Startseite ohne Werbung unmittelbar
mit dem Katalog beginnt; und die vier oberen Bereiche sind als
Schleife ausgeführt, in der die Einträge in festem Takt von rechts
nach links wandern, statt untereinander zu stehen. Beides hält die
Seite unabhängig davon kurz, wie viele Platzierungen gebucht sind.
 
Den Abschluss bilden zwei gleichartig aufgebaute Abschnitte, einer für
die zuletzt eingestellten Produkte und einer für die zuletzt
eingestellten Dienstleistungen. Beide bestehen aus einer Überschrift
und einem Raster aus Vorschaukarten.
...
in der angeforderten Sprache. Diese Aufteilung folgt aus der Herkunft der Daten, nicht aus einer Entwurfsentscheidung: Ein Anbieter erfasst Titel und Beschreibung mehrsprachig (vgl. Abschnitt~\ref{subsec:verkaeufer_dashboard_konzept}), weshalb nur das Backend beide Fassungen kennt.
...
vor, sodass eine deutsche Fassung nicht entsteht. Anforderung und Verfügbarkeit einer Sprache sind damit zwei getrennte Fragen: Das Frontend kann jede Sprache anfordern, geliefert wird nur, was zuvor erfasst wurde.
