...
Grund, der in Abschnitt~\ref{subsec:checkout_konzept} zur Einbindung
...
seine Nachricht angekommen ist -- eine Rückmeldung, die bei einem
Austausch zwischen Fremden den Unterschied ausmacht zwischen einem
schweigenden Gegenüber und einer Nachricht, die ihn nicht erreicht
hat (vgl. Abschnitt~\ref{subsec:gestaltungsprinzipien}).