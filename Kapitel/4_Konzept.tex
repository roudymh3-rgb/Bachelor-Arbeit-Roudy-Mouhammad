...
sowie den Produkt- und Dienstleistungskatalog
inklusive der öffentlichen Verkäufer- und
Dienstleister-Profile abbilden. Für Warenkorb
...
Schichten. Die unterste Schicht bildet ein zentraler
...
% TODO (Roudy): Absatz zur Abgrenzung Client-State (State
% Management, Abschnitt 4.1.3) vs. Server-State (TanStack Query)
% hier wieder ergaenzen, sobald die Zustand-vs-Context-Entscheidung
% final ist. Inhaltlich bereits fertig, siehe fruehere Version im
% Chat-Verlauf.
...
der Bearbeitung deaktiviert. Abbildung~\ref{fig:login-vs-register}
und Abbildung~\ref{fig:validierung-fehler}
stellen beide Konzepte gegenüber.

\begin{figure}[H]
\centering
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth]{Bilder/abb_login_vs_register.png}
\caption{Login und Registrierung im Vergleich}
\label{fig:login-vs-register}
\end{minipage}
\hfill
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth]{Bilder/abb_validierung_fehler.png}
\caption{Formularvalidierung und Fehlerrückmeldung}
...
erhalten, und reaktiv über die React Context API
bereitgestellt (vgl.
...
Abbildung~\ref{fig:session-konzept} und
Abbildung~\ref{fig:routenschutz} zeigen beide
Abläufe.
...
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth]{Bilder/abb_authentifizierung_ablauf.png}
\caption{Ablauf der Authentifizierung}
\label{fig:session-konzept}
\end{minipage}
\hfill
\begin{minipage}{0.48\linewidth}
\centering
\includegraphics[width=\linewidth]{Bilder/abb_routenschutz.png}
\caption{Dreistufiger rollenbasierter Seitenschutz}
...
Abbildung~\ref{fig:interceptor-rollenmodell}
fasst Tokenversand und Rollen-Upgrade zusammen.

\begin{figure}[H]
\centering
\includegraphics[width=0.55\textwidth]{Bilder/abb_interceptor_rollenmodell.png}
