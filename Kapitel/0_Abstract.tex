...
The platform distinguishes four user roles: buyers, sellers,
service providers, and administrators. The developed frontend
covers the functional areas of the first three roles;
administrative functions are handled through the admin dashboard
