...
React provides the user interface layer, React Router handles
client-side routing with role-based route protection, and the
Zustand library manages global application state for authentication,
