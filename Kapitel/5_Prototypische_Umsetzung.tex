...
benannte Exporte sind.
 
Drei Bausteine sind ausgenommen: Der Anwendungsrahmen ist auf jeder
Seite sichtbar, die Wrapper-Komponente des rollenbasierten
Seitenschutzes umschließt nahezu jede Route, und die Startseite ist
der häufigste Einstiegspunkt. Ein Nachladen dieser drei würde den
ersten Aufruf verlangsamen statt ihn zu beschleunigen.
...
Inhaltsbereich und nicht um die gesamte Anwendung:
...
Dadurch bleiben Kopfzeile, Navigation und Warenkorb während des
Wechsels sichtbar; ersetzt wird nur der Inhaltsbereich. Der
Platzhalter ist ein Gerüst aus Flächen in der Farbe
...
Abbildung~\ref{abb:lazy_network} zeigt den Vorgang im Betrieb: Beim
Wechsel auf die Produktseite lädt der Browser fünf zuvor nicht
...
Die Zahlungsseite selbst wird vom Zahlungsdienstleister bereitgestellt
und ist damit nicht Gegenstand der Umsetzung; das Frontend nimmt
lediglich die Rückleitung entgegen (vgl.
Abschnitt~\ref{subsec:online-zahlung}).
...
\end{minipage}
\caption{Detailansicht eines Auftrags mit nicht abgeschlossener Zahlung
  (links) und eines bezahlten Auftrags mit Produkt- und
...
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[width=1.52\textwidth]{Bilder/screenshot_buchung_offen.png}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[width=1.60\textwidth]{Bilder/screenshot_buchung_frist_abgelaufen.png}
\end{minipage}
\caption{Buchung innerhalb der Fristen mit auslösbaren Schaltflächen und
  Angabe des Fristendes (links); nach Ablauf beider Fristen sind die
  Schaltflächen deaktiviert und der Grund steht darüber (rechts)}
