...
Dienstleistungsangebote, die Verwaltung der Verfügbarkeit -- als
eigener Funktionsbereich \texttt{provider-availability/} umgesetzt,
der derselben internen Struktur folgt wie die übrigen (vgl.
Abschnitt~\ref{subsec:komponentenarchitektur}) -- sowie die
Produktverwaltung, die demselben Muster folgt.
...
über den Vergleich der AbsenderID mit der ID des
