...
wiederverwendbare Komponente \texttt{WorkingHoursEditor}
...
eingetragenen Abwesenheitszeiträume wird vor der Anzeige
chronologisch nach ihrem Beginn sortiert und für jeden Eintrag
der Zeitpunkt anhand der beim Anbieter hinterlegten Zeitzone
formatiert, anstatt die Zeitzone des aufrufenden Endgeräts zu
verwenden, damit Kunden die Verfügbarkeit unabhängig vom eigenen
