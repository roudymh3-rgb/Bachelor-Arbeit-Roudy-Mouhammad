...
Mechanismen zur gezielten Invalidierung von Cache-Einträgen; projektweite Konfiguration ist einer späteren Ausbaustufe der
Anwendung vorbehalten und wird in dieser Arbeit nicht weiter
vertieft.
% TODO (Roudy): Diesen Satz ("...spaeteren Ausbaustufe...")
% nach dem Mentor-Gespraech zur Caching-Strategie ggf.
% anpassen/konkretisieren -- der folgende Bruecken-Satz
% (Query-Key/Cache-Mechanismus) bleibt davon unberuehrt und
% muss nicht mehr geaendert werden.
Dieses Muster aus Query Key, Cache und einheitlichen
Verbindungszuständen kommt bei sämtlichen weiteren Datenabrufen
der Anwendung in gleicher Form zum Einsatz und wird in den
folgenden Abschnitten jeweils nur noch kurz referenziert.
