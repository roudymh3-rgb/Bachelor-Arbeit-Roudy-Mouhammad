...
Auftrags, das Hinzufügen der Artikelarten und das Anfordern der
...
Produkte und Dienstleistungsbuchungen enthalten kann. Die Handlungsfolge des Checkouts wird
...
der eigenen Bestellungen und die Liste der eigenen Buchungen. Der
Grund ist der in Abschnitt~\ref{subsec:impl_tanstackquery}
beschriebene Mechanismus: Nach erfolgreicher Zahlung existiert im
Backend ein Auftrag mehr als im Cache hinterlegt, und der Status des
betroffenen Auftrags hat sich von \textit{requires payment} auf
\textit{paid} geändert. Ohne Invalidierung würde die Anwendung
weiterhin den veralteten Stand anzeigen.
...
wiederverwendbare Komponente \small\texttt{WorkingHoursEditor} dargestellt,
