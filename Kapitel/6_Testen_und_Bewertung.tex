...
Für die Performance liegt eine messbare Größe vor: Der ausgelieferte
Programmcode ist in 102 Dateien aufgeteilt, von denen beim ersten
Aufruf nur ein Teil übertragen wird; die größte bleibt mit 230~kB
unter der Schwelle von 500~kB, auf die das Build-Werkzeug hinweist
(vgl. Abschnitt~\ref{sec:impl_lazyloading}). Die geforderten
Ladezustände sind vorhanden; konkrete Antwortzeiten wurden jedoch
nicht gemessen.
